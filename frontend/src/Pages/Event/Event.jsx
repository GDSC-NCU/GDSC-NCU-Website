...
function Event() {
  ...
  return (
    <>
    <h1 style={{ marginTop: "100px", fontFamily: 'Manrope', fontSize: '30px' ,marginLeft:'40px' }}>Upcoming Events</h1>
...
<h1 style={{ fontFamily: 'Manrope', fontSize: '30px' ,marginLeft:'40px' }}>Past Events</h1>
